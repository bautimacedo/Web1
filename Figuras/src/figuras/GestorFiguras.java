...
public class GestorFiguras {
    ...
    public GestorFiguras () {
        ...
        HerramientaDeAzar generador = new HerramientaDeAzar();
    ...
    public void agregarFiguraAleatoria () {
        HerramientaDeAzar hola= new HerramientaDeAzar();
        figuras.add(hola.getFiguraAleatoria());
    }
    ...
    public void crearFigurasAleatoriamente(Integer cantidad) {
        int counter = 0;
       HerramientaDeAzar[] generador = new HerramientaDeAzar[cantidad];
       for(int i=0 ; i<cantidad ; i++)
       {
           generador[i] = new HerramientaDeAzar(); 
           figuras.add(generador[i].getFiguraAleatoria());
       }
    ...
    {
       for(FiguraGeometrica listado : figuras)
        {
            System.out.println("Posicion: " + listado.toString());
            System.out.println("Superficie: "+ listado.getSuperficie());
            System.out.println("Perimetro: "+ listado.getPerimetro());
            System.out.println();
        }
    }
    ...
    public void listarFigurasOrdenadas() {
        ...
        for(FiguraGeometrica orden : figuras)
        {
            System.out.println("Posicion: " + orden.toString());
            System.out.println("Superficie: "+ orden.getSuperficie());
            System.out.println("Perimetro: "+ orden.getPerimetro());
            System.out.println();
        }
    }
